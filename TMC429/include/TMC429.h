// ----------------------------------------------------------------------------
// TMC429.h - Raspberry Pi Pico Port
//
// Original Authors:
...
void setup(size_t chip_select_pin,
  ...
  spi_inst_t* spi_instance = spi_default);  // Add optional parameter with default
...
private:
  ...
  // Pico SPI functions (removed virtual and SPISettings)
  void spiBegin();
